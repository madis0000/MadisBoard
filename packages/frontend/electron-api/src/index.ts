...
} from '@madisboard/electron/helper/exposed';
import type {
  events as mainEvents,
  handlers as mainHandlers,
} from '@madisboard/electron/main/exposed';
import type { AppInfo } from '@madisboard/electron/preload/electron-api';
import type { SharedStorage } from '@madisboard/electron/preload/shared-storage';
...
export type { UpdateMeta } from '@madisboard/electron/main/updater/event';
export type {
  AddTabOption,
  TabAction,
} from '@madisboard/electron/main/windows-manager';
