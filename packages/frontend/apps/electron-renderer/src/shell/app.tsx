...
import { configureAppSidebarModule } from '@madisboard/core/modules/app-sidebar';
import { ShellAppSidebarFallback } from '@madisboard/core/modules/app-sidebar/views';
import {
  AppTabsHeader,
