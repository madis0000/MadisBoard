...
import { DocStorage, ValidationResult } from '@madisboard/native';
import { parseUniversalId } from '@madisboard/nbstore';
...
async function cpV1DBFile(
  ...
  const { SqliteConnection } = await import('@madisboard/native');
