...
import { OpenInAppPage } from '@madisboard/core/modules/open-in-app/views/open-in-app-page';
import {
  appSchemaUrl,
  appSchemes,
  channelToScheme,
} from '@madisboard/core/utils/channel';
import type { GetCurrentUserQuery } from '@madisboard/graphql';
