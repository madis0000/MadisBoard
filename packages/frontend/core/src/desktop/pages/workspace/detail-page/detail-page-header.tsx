...
import { FavoriteButton } from '@madisboard/core/blocksuite/block-suite-header/favorite';
import { InfoButton } from '@madisboard/core/blocksuite/block-suite-header/info';
import { JournalWeekDatePicker } from '@madisboard/core/blocksuite/block-suite-header/journal/date-picker';
import { JournalTodayButton } from '@madisboard/core/blocksuite/block-suite-header/journal/today-button';
import { PageHeaderMenuButton } from '@madisboard/core/blocksuite/block-suite-header/menu';
import { DetailPageHeaderPresentButton } from '@madisboard/core/blocksuite/block-suite-header/present/detail-header-present-button';
import { BlocksuiteHeaderTitle } from '@madisboard/core/blocksuite/block-suite-header/title';
import { EditorModeSwitch } from '@madisboard/core/blocksuite/block-suite-mode-switch';
import { useRegisterCopyLinkCommands } from '@madisboard/core/components/hooks/affine/use-register-copy-link-commands';
import { HeaderDivider } from '@madisboard/core/components/pure/header';
...
import { SharePageButton } from '@madisboard/core/modules/share-menu';
import { TemplateDocService } from '@madisboard/core/modules/template-doc';
import { ViewIcon, ViewTitle } from '@madisboard/core/modules/workbench';
