...
import { DetailPageWrapper } from '@madisboard/core/desktop/pages/workspace/detail-page/detail-page-wrapper';
import { PageHeader } from '@madisboard/core/mobile/components';
import { useGlobalEvent } from '@madisboard/core/mobile/hooks/use-global-events';
import { AIButtonService } from '@madisboard/core/modules/ai-button';
