import { Button, notify, Switch, Tooltip } from '@madisboard/component';
import {
  SettingHeader,
  SettingRow,
  SettingWrapper,
...
import { EnableCloudPanel } from '@madisboard/core/desktop/dialogs/setting/workspace-setting/preference/enable-cloud';
